    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-8">
        <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <div class="text-2xl font-bold text-[#16302A]">3</div>
        ...
        <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <div class="text-2xl font-bold text-[#16302A]">15</div>
        ...
        <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <div class="text-2xl font-bold text-[#16302A]">Rs. 18,450</div>
        ...
        <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 col-span-2 md:col-span-1">
            <div class="flex items-center gap-3">
                ...
                <div class="flex-1">
                    <div class="text-2xl font-bold text-[#16302A]">4.8</div>
                    ...
                    <div class="text-xs text-gray-500 font-medium">Average Rating</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="lg:col-span-2">
            <section class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <h2 class="text-xl font-bold text-[#16302A] mb-6 heading-underline">New Leads</h2>
    ...
    <section class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="bg-[#F5F1EA] rounded-xl p-5 border border-gray-200">
                ...
                <p class="text-sm text-gray-700 mb-3">"Excellent service! Muhammad fixed our leaking pipe quickly and cleanly. Highly recommend!"</p>
                <div class="flex items-center justify-between">
                    <p class="text-xs font-semibold text-[#16302A]">— Ali Hassan</p>
                    <p class="text-xs text-gray-500">Jul 3, 2026</p>
                </div>
            </div>
            ...
            <div class="bg-[#F5F1EA] rounded-xl p-5 border border-gray-200">
                ...
                <div class="flex items-center justify-between">
                    <p class="text-xs font-semibold text-[#16302A]">— Fatima Qureshi</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="text-xs font-medium text-gray-500 mb-1 block">Trade/Specialty</label>
                        <input type="text" value="{{ Auth::user()->trade ?? 'Plumbing' }}" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-[#E8823C] focus:border-[#E8823C] outline-none">
                    </div>
                    <div>
                        <label class="text-xs font-medium text-gray-500 mb-1 block">Years of Experience</label>
                        <input type="number" value="5" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-[#E8823C] focus:border-[#E8823C] outline-none">
                    </div>
                    <div>
                        <label class="text-xs font-medium text-gray-500 mb-1 block">Starting Price</label>
                        <input type="text" value="Rs. 800" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-[#E8823C] focus:border-[#E8823C] outline-none">
                    </div>
                    <div>
                        <label class="text-xs font-medium text-gray-500 mb-1 block">Service Area/Location</label>
                        <input type="text" value="{{ Auth::user()->location ?? 'Karachi' }}" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-[#E8823C] focus:border-[#E8823C] outline-none">
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-3 gap-2 mb-2">
                        <div class="aspect-square bg-[#F5F1EA] rounded-lg flex items-center justify-center border-2 border-dashed border-gray-300">
                    ...
                    <p class="text-xs text-gray-500">Add photos of your work to attract more customers</p>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center bg-[#F5F1EA]">
                        <p class="text-xs text-gray-600">Upload your certifications</p>
                        <button class="text-xs text-[#E8823C] font-semibold mt-1">Choose Files</button>
                    </div>
                </div>
            </div>
        </div>
