...
<div class="main" id="main">
    ...
    <div class="content">
        ...
        <div class="page-sub">Manage all customers on the platform</div>
        <div class="table-card">
            <div class="table-header">
                <div>
                    <div class="card-title" style="font-size:1rem;font-weight:700;color:#111827;">All Customers</div>
                </div>
                <form method="GET" action="{{ route('admin.customers') }}" class="filters">
                    <input type="text" name="search" class="filter-input" placeholder="Search name/email/phone" value="{{ request('search') }}">
            ...
            <table>
                ...
                <tbody>
                    @if($customers->count() > 0)
                        ...
                        @endforeach
                    @else
                        <tr><td colspan="6" style="text-align:center;padding:30px;color:#9ca3af;">No customers found</td></tr>
                    @endif
                </tbody>
            </table>
