...
<head>
    ...
    <title>FixIt – Reports & Analytics</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .kpi-card { background: #fff; border-radius: 14px; padding: 24px; border: 1px solid #ece8df; box-shadow: 0 2px 8px rgba(0,0,0,0.04); }
        .kpi-value { font-size: 2rem; font-weight: 800; color: #111827; margin-bottom: 4px; }
        .kpi-label { font-size: 0.85rem; color: #9ca3af; }
        ...
        .filter-select { padding: 8px 12px; border: 1px solid #e5e7eb; border-radius: 8px; font-size: 0.85rem; margin-bottom: 16px; }
...
<div class="main" id="main">
    ...
    <div class="content">
        ...
        <div class="page-sub">View platform performance and analytics</div>
        ...
        <div class="kpi-grid">
            <div class="kpi-card">
                <div class="kpi-value">Rs. {{ number_format($revenue, 2) }}</div>
        ...
        @if($jobsByTrade->count() > 0)
            <div class="table-card">
                <div class="table-header" style="padding:20px 24px;">
                    <div class="card-title" style="margin-bottom:0;">Jobs by Trade</div>
                </div>
                <table>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @foreach($jobsByTrade as $trade)
                            <tr>
                                <td>{{ $trade->trade_category ?: 'N/A' }}</td>
                                <td>{{ $trade->total }}</td>
                            </tr>
                        @endforeach
                    </tbody>
