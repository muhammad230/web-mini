...
<head>
    ...
    <title>FixIt – Payments & Payouts</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .card-icon { width: 80px; height: 80px; background: #fff0e8; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 24px; }
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="nav-section">
        ...
        <a href="{{ route('admin.payments') }}" class="nav-item active">
            <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
            <span>Payments & Payouts</span>
        </a>
        <a href="{{ route('admin.reports') }}" class="nav-item">
            <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 0 002 2h2a2 2 0 002 2v10m-6 0a2 2 0 002 2h2a2 2 0 012 2v14a2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
...
<div class="main" id="main">
    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-icon">
                <svg width="40" height="40" fill="none" stroke="#E8823C" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
            </div>
            <div class="card-title">Coming Soon</div>
            <div class="card-text">Payment and payout features are not yet implemented. This section will be updated when a real payment gateway is integrated.</div>
        </div>
    </div>
</div>
<script>
