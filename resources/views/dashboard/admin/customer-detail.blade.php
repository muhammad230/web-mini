...
<head>
    ...
    <title>FixIt – Customer Detail</title>
    ...
    <div class="content">
            ...
            <div class="customer-header">
                ...
                <div class="customer-info">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value">{{ $customer->customerJobs->count() }}</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Status:</span>
                        <span class="info-value">{{ $customer->available ? 'Active' : 'Suspended' }}</span>
                    </div>
                    <div class="info-row">
        ...
        <div class="table-card">
            ...
            <table>
                ...
                <tbody>
                    @if($customer->customerJobs->count() > 0)
                        @foreach($customer->customerJobs as $job)
                            <tr>
                        ...
                        @endforeach
                    @else
                        <tr><td colspan="5" style="text-align:center;padding:30px;color:#9ca3af;">No jobs yet</td></tr>
                    @endif
                </tbody>
            </table>
        </div>
