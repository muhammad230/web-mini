...
<head>
    ...
    <title>Fixly – Professionals</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 1024px) {
            ...
            td:last-child .action-btn { margin-bottom: 2px; }
        }
        @media (max-width: 768px) { .content { padding: 20px 16px; } .topbar { padding: 12px 16px; } .search-box { width: 160px; } }
        @media (max-width: 600px) { .table-header { flex-direction: column; align-items: stretch; } .filters { flex-direction: column; } .filter-input { width: 100%; } .search-box { width: 140px; } h1.page-title { font-size: 1.15rem; } }
    </style>
</head>
<body>
<!-- Sidebar Overlay -->
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="nav-section">
        ...
        <a href="{{ route('admin.professionals') }}" class="nav-item active">
...
<div class="main" id="main">
    ...
    <div class="content">
        ...
        <div class="page-sub">Manage all professionals on the platform</div>
        <div class="table-card">
            <div class="table-header">
                <div>
                    <div class="card-title" style="font-size:1rem;font-weight:700;color:#111827;">All Professionals</div>
                </div>
                <form method="GET" action="{{ route('admin.professionals') }}" class="filters">
                    <input type="text" name="search" class="filter-input" placeholder="Search name/email" value="{{ request('search') }}">
                    <select name="trade" class="filter-input">
                        <option value="">All Trades</option>
                        <option value="Plumber" {{ request('trade') == 'Plumber' ? 'selected' : '' }}>Plumber</option>
                        <option value="Electrician" {{ request('trade') == 'Electrician' ? 'selected' : '' }}>Electrician</option>
                        <option value="Carpenter" {{ request('trade') == 'Carpenter' ? 'selected' : '' }}>Carpenter</option>
                        <option value="Painter" {{ request('trade') == 'Painter' ? 'selected' : '' }}>Painter</option>
                    </select>
            ...
            <table>
                ...
                <tbody>
                    ...
                    @else
                        <tr>
                            <td colspan="8" style="text-align:center;padding:30px;color:#9ca3af;">No professionals found</td>
                        </tr>
                    @endif
                </tbody>
            </table>
