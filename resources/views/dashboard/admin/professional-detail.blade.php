...
<head>
    ...
    <title>FixIt – Professional Detail</title>
...
<div class="main" id="main">
    ...
    <div class="content">
        <a href="{{ route('admin.professionals') }}" class="back-btn">
            <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7"/></svg>
            Back to Professionals
        </a>
        <div class="page-title">{{ $professional->name }}</div>
            ...
            <div class="pro-header">
                ...
                <div class="pro-info">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value">{{ $professional->phone ?: 'N/A' }}</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Trade:</span>
                        <span class="info-value">{{ $professional->trade ?: 'N/A' }}</span>
                    </div>
                    <div class="info-row">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value">{{ $professional->jobs_completed }}</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Status:</span>
                        <span class="info-value status-badge status-{{ $professional->verification_status }}">{{ ucfirst($professional->verification_status) }}</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Availability:</span>
                        <span class="info-value">{{ $professional->available ? 'Available' : 'Suspended' }}</span>
                    </div>
                    <div class="info-row">
        ...
        <div class="table-card">
            ...
            <table>
                ...
                <tbody>
                    @if($professional->assignedJobs->count() > 0)
                        @foreach($professional->assignedJobs as $job)
                            <tr>
                        ...
                        @endforeach
                    @else
                        <tr><td colspan="5" style="text-align:center;padding:30px;color:#9ca3af;">No jobs found</td></tr>
                    @endif
                </tbody>
            </table>
        </div>
        <div class="table-card">
            <div class="table-header" style="padding:20px 24px;">
                <div class="card-title" style="margin-bottom:0;">Reviews</div>
            </div>
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    @if($professional->reviewsReceived->count() > 0)
                        @foreach($professional->reviewsReceived as $review)
                            <tr>
                        ...
                        @endforeach
                    @else
                        <tr><td colspan="4" style="text-align:center;padding:30px;color:#9ca3af;">No reviews yet</td></tr>
                    @endif
                </tbody>
            </table>
        </div>
