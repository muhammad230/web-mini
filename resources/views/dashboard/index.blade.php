...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="nav-section">
        ...
        <a href="#" class="nav-item">
            ...
            <span style="margin-left:auto;background:#E8823C;color:#fff;font-size:0.65rem;font-weight:700;padding:1px 7px;border-radius:20px;">5</span>
        </a>
        <a href="#" class="nav-item">
    ...
    <div class="sidebar-bottom">
        <div class="admin-profile">
            ...
            <div class="admin-info">
                <div class="name">Zain Admin</div>
                <div class="role">Super Admin</div>
            </div>
        </div>
        <button class="logout-btn" style="margin-top:10px;">
    ...
    <div class="topbar">
        ...
        <div class="topbar-right">
            <button class="notif-btn">
                <svg width="20" height="20" fill="none" stroke="#6b7280" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>
                <span class="notif-dot"></span>
            </button>
            <div class="admin-topbar">
                <img src="https://randomuser.me/api/portraits/men/10.jpg" alt="Admin">
                <div>
                    <div class="tname">Zain Admin</div>
